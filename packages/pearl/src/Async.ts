...
export default class AsyncManager {
  ...
  /**
   * Returns a yieldable promise to wait a certain amount of milliseconds. Once
   * a time-scale system is implemented, this will wait the *time-scaled*
   * duration - so if you wait 50 ms and set your time scale to 1/2 speed, it
   * will take 100 ms to resolve.
   */
  ...
  update(dt: number) {
    ...
    //
    // TODO: This doesn't enforce timers being resolved in scheduled order!!!
    // Need an ordered data structure
